...
--				This table represents all our recipients with messages in the inbox
--				
...
if not exists (select 1 from information_schema.tables where table_name = 'RECIP_MSG_INBOX')
begin
  create table dbo.RECIP_MSG_INBOX (
	...
	,constraint FK_RECIP_INBOX foreign key(RECIP_PHONE)
